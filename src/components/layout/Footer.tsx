    ...
    <footer className="bg-[#050505] border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center text-white/60 hover:bg-brand-pink hover:text-white transition-all duration-200"
              >
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-display text-white font-semibold text-lg mb-5">
              Quick Links
            </h3>
