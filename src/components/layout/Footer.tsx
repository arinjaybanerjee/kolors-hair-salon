          ...
          <div>
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-9 h-9 rounded-full bg-brand-black/10 flex items-center justify-center text-brand-black/60 hover:bg-brand-pink hover:text-white transition-all duration-200"
              >
